...
<body style="background-image: url(assets/images/carnival-bg.jpg)">
...
<div class="container">
        <div class="row">
                ...
                <div class="countdown-timer mb-30" style="margin-top:20px">
                        ...
                        <img src="assets\images\golibe-logo-portrait.png" width="80%" height="auto" style="padding:50px; display: block; margin:auto;" />
                        <a class="enter-text" href="home/">Proceed to Site >>></a>
                </div>
        <div>
        </div>
                                                        ...
                                                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                                                <div class="row">
                                                                        <div class="land-brand-logo">
                                                                                <img src="assets/images/brand-kex.png"/>
                                                                        </div>
                                                                        <div class="land-brand-logo">
